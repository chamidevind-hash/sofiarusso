...
export default function HomePage() {
  ...
  return (
    <section className="sofia-bio-page relative isolate min-h-[100svh] overflow-x-hidden bg-[var(--page-bg)] text-[var(--text-primary)]">
      ...
      <div className="relative z-10 mx-auto min-h-[100svh] w-full max-w-[520px] bg-[var(--page-bg)] shadow-none sm:my-6 sm:min-h-[calc(100svh-48px)] sm:overflow-hidden sm:rounded-[30px] sm:border sm:border-white/10 sm:shadow-[0_28px_90px_rgba(0,0,0,0.52)]">
        <SofiaProfileCover />
