  ...
  return (
    <Link
      ...
      className={`group block ${
        featured ? "lg:grid lg:grid-cols-2 lg:gap-10" : ""
      }`}
    >
      <div
      ...
      <div
        className={`border-b border-ink/15 py-6 ${
          featured
            ? "lg:flex lg:flex-col lg:justify-center lg:border-y"
            : ""
        }`}
      >
        ...
        <div className="mt-6 flex items-center justify-between">
          <p className="text-[9px] font-bold uppercase tracking-editorial text-ink/45">
            {post.date}
          </p>
